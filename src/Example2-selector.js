...
const TempCelcius = () => {
    ...
    return (
        <div>
            ...
            <button onClick={()=>setTempCelcius(celcius=>celcius+100)}>Add 100 Celcius</button>
        </div>
    )
}

const Example2Selector = () => {
    return (
        <div>
            <h1>Calculator</h1>
            <Farenheit/>
...
export default Example2Selector;
